...
var imagensAnimais = [
    "../nep-um/Imagens/animais/cao.png",
    "../nep-um/Imagens/animais/elefante.png",
    "../nep-um/Imagens/animais/galinha.png",
    "../nep-um/Imagens/animais/galinhaBranca.png",
    "../nep-um/Imagens/animais/leao.png",
    "../nep-um/Imagens/animais/mocho.png",
    "../nep-um/Imagens/animais/pantera.png",
    "../nep-um/Imagens/animais/pingu.png",
    "../nep-um/Imagens/animais/tigre.png",
    "../nep-um/Imagens/animais/zebra.png"
];
...
function abrirCarta() {
    ...
    if ($(this).children().is(":hidden")) {
        ...
        if (imagensAnimais.length === paresEncontrados) {
