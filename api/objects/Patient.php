...
function searchPatient($params) {
    ...
    if (isset($params['name'])) {
      ...
      if(count($splitedName)===1){
        ...
        $query = "SELECT * FROM Patient where idHealthProfessional=$idHealthProfessional and  name like '%$firstName%' or lastName like '%$lastName%'";
      }

    }else{
      $numTel=$params['numTel'];
      $query="SELECT * FROM Patient where idHealthProfessional=$idHealthProfessional and numTel=$numTel ";
    }
