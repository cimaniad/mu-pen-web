...
function getPatientById($params) {
    ...
    $query = "Select p.idPatientid, p.HealthProfessional, p.email, p.password, p.name, p.lastName, p.numCC ,p.numTel, p.birthDate, p.gender, p.pathology, p.nationality, p.adress, p.nif, p.maritalStatus, p.bloodGroup, p.description, p.picture, p.notification, hp.name  From Patient p, HealthProfessional hp Where idPatient='$id' and p.idHealthProfessional=hp.idHealthProfessional";
